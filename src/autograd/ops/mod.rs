...
impl Tensor {
    ...
    pub fn add(&self, other: &Tensor) -> Tensor {
        if self.is_transposed() || other.is_transposed() {
            return self.contiguous().add(&other.contiguous());
        }
    ...
    pub fn sub(&self, other: &Tensor) -> Tensor {
        if self.is_transposed() || other.is_transposed() {
            return self.contiguous().sub(&other.contiguous());
        }
        let src_a = self.data();
    ...
    pub fn mul(&self, other: &Tensor) -> Tensor {
        if self.is_transposed() || other.is_transposed() {
            return self.contiguous().mul(&other.contiguous());
        }
        let src_a = self.data();
        let src_b = other.data();
        let n = src_a.len();
    ...
    pub fn div(&self, other: &Tensor) -> Tensor {
        if self.is_transposed() || other.is_transposed() {
            return self.contiguous().div(&other.contiguous());
        }
        let src_a = self.data();
        let src_b = other.data();
        let n = src_a.len();
    ...
    pub fn mul_scalar(&self, scalar: f32) -> Tensor {
        if self.is_transposed() {
            return self.contiguous().mul_scalar(scalar);
        }
