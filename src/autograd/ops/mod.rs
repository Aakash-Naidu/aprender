...
impl Tensor {
    ...
    pub fn add(&self, other: &Tensor) -> Tensor {
        ...
        let data = trueno::blis::elementwise::add_alloc(a.data(), b.data());
    ...
    pub fn mul_scalar(&self, scalar: f32) -> Tensor {
        ...
        let data = trueno::blis::elementwise::mul_scalar_alloc(a.data(), scalar);
        let mut result = Tensor::from_vec(data, self.shape());
...
impl Tensor {
    ...
    pub fn exp(&self) -> Tensor {
        ...
        let data: Vec<f32> = a.data().iter().map(|&a| a.exp()).collect();
        let mut result = Tensor::from_vec(data, self.shape());
    ...
    pub fn log(&self) -> Tensor {
        ...
        let data: Vec<f32> = a.data().iter().map(|&a| a.ln()).collect();
        let mut result = Tensor::from_vec(data, self.shape());
    ...
    pub fn pow(&self, n: f32) -> Tensor {
        ...
        let data: Vec<f32> = a.data().iter().map(|&a| a.powf(n)).collect();
        let mut result = Tensor::from_vec(data, self.shape());
    ...
    pub fn sqrt(&self) -> Tensor {
        ...
        let data: Vec<f32> = a.data().iter().map(|&a| a.sqrt()).collect();
        let mut result = Tensor::from_vec(data, self.shape());
